<?php
	...
	if(isset($_POST['email']))
	{
		...
		//Poprawność email
		$email  = $_POST['email'];
		$emailB = filter_var($email, FILTER_SANITIZE_EMAIL);//B=bezpieczny
		//echo $emailB; exit();
		...
		//Bot or not?
		$sekret = "6LfYhQkUAAAAAMvbujSyYhfaYhR4K2UaDA55CpeO";
...
<body>
	<form method="post">
		...
		?>
		<div class="g-recaptcha" data-sitekey="6LfYhQkUAAAAAAc8Bspc8zih4718U53toRkUwquc"></div>
		<?php
